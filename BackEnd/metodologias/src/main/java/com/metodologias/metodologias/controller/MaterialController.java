...
public class MaterialController {
	...
	public @ResponseBody ResponseEntity<MaterialDTO> editMaterial(@PathVariable("id") Long idMaterial,@RequestBody MaterialDTO material ){
		try {	
			return new ResponseEntity<MaterialDTO>(materialService.editMaterial(idMaterial,material),HttpStatus.OK);
		}catch(MaterialNotFound e) {
			LOGGER.error(INTERNAL_SERVER_ERROR,e);
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}catch(Exception e) {
